...
- `notebooks/svm_banknote_tutorial.ipynb` — main notebook with full code, results, and figures
- `tutorial/SVM_Kernels_Banknote_Tutorial.pdf` — tutorial PDF
- `data/banknote_authentication.csv` — dataset used in the notebook
- `figures/` — saved output figures generated by the notebook
